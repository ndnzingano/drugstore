...
namespace drugstore.Controllers
{
    public class MedicinesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Formula,ExpiryDate,Lab,Quantity,Price")] Medicine medicine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Formula,ExpiryDate,Lab,Quantity,Price")] Medicine medicine)
        {
            if (id != medicine.Id)
            {
                return NotFound();
